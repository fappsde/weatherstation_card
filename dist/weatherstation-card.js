...
`),tt=Ae(B`
  ...
  <path d="m7 20.5 5-5"/>
  <path d="m12 15.5 5 5"/>
`),it={temperature:Ee,humidity:Se,pressure:He,wind_speed:De,wind_direction:Te,wind_gust:Pe,rain:Le,rain_rate:Oe,uv_index:Ve,solar_radiation:ze,feels_like:je,dew_point:We,moisture:Ne},rt=Ue;function st(e,t="°C"){return`${Math.round(10*e)/10}${t}`}function at(e,t="km/h"){return`${Math.round(10*e)/10} ${t}`}function nt(e,t="mm"){return`${Math.round(100*e)/100} ${t}`}function ot(e){return e*Math.PI/180}const dt=36e5;function ct(e,t,i,r="1h"){if(0===t.length)return{direction:"stable",percentChange:0,absoluteChange:0,timeframe:r,previousValue:e,confidence:0};if(1===t.length){const s=t[0].value,a=e-s,n=0!==s?a/s*100:0,o=be[i]||{significant:.1};let d="stable";return Math.abs(a)>=o.significant&&(d=a>0?"up":"down"),{direction:d,percentChange:Math.round(10*n)/10,absoluteChange:Math.round(10*a)/10,timeframe:r,previousValue:s,confidence:0}}const{slope:s,intercept:a,r2:n,windowHours:o}=function(e){const t=e.length;if(0===t)return{slope:0,intercept:0,r2:0,windowHours:0};if(1===t)return{slope:0,intercept:e[0].value,r2:0,windowHours:0};const i=e[0].timestamp;let r=0,s=0,a=0,n=0,o=0;for(const t of e){const e=(t.timestamp-i)/dt,d=t.value;r+=e,s+=d,a+=e*d,n+=e*e,o+=d*d}const d=t*n-r*r;if(0===d)return{slope:0,intercept:s/t,r2:0,windowHours:0};const c=(t*a-r*s)/d,h=(s-c*r)/t,l=t*o-s*s,p=0===l?0:Math.pow(t*a-r*s,2)/(d*l),u=(e[e.length-1].timestamp-i)/dt;return{slope:c,intercept:h,r2:Math.min(p,1),windowHours:u}}(t),d=s*o,c=a,h=0!==c?d/c*100:0,l=be[i]||{significant:.1};let p="stable";return Math.abs(d)>=l.significant&&n>=.1&&(p=d>0?"up":"down"),{direction:p,percentChange:Math.round(10*h)/10,absoluteChange:Math.round(10*d)/10,timeframe:r,previousValue:Math.round(10*c)/10,confidence:Math.round(100*n)/100}}function ht(e,t){const i=be[e]||{major:1};return Math.abs(t)>=i.major}function lt(e=new Date){const t=e.getHours();return t>=5&&t<8?"dawn":t>=8&&t<18?"day":t>=18&&t<21?"dusk":"night"}function pt(e){const t="night"===lt();if(void 0!==e.rain_rate&&e.rain_rate>0)return void 0!==e.wind_speed&&e.wind_speed>50?"stormy":"rainy";if(void 0!==e.wind_speed&&e.wind_speed>40)return"windy";if(void 0!==e.solar_radiation){const i=function(e){if(e<6||e>20)return 0;const t=Math.abs(e-12);return Math.max(0,1e3*(1-t/8))}((new Date).getHours()),r=i>0?e.solar_radiation/i:1;return r>.7?t?"clear-night":"sunny":r>.3?"partly-cloudy":"cloudy"}return t?"clear-night":"sunny"}function ut(e,t){switch(t){case"temperature":case"feels_like":case"dew_point":return st(e);case"humidity":return`${Math.round(e)}%`;case"pressure":return function(e,t="hPa"){return`${Math.round(e)} ${t}`}(e);case"wind_speed":case"wind_gust":return at(e);case"rain":case"rain_rate":return nt(e);case"uv_index":default:return""+Math.round(10*e)/10;case"solar_radiation":return`${Math.round(e)} W/m²`}}let mt=class extends ce{constructor(){super(...arguments),this.windDirection=0,this.windSpeed=0,this.showArrows=!0,this.compact=!1,this.animate=!0}render(){const e=this.compact?80:120,t=e/2,i=e/2-8;return I`
    ...
    `}_formValueChanged(e){if(e.stopPropagation(),!this._config||!this.hass)return;const t=e.detail.value,i=JSON.parse(JSON.stringify(this._config));Object.entries(t).forEach(([e,t])=>{if(e.startsWith("entities_")){const r=e.replace("entities_","");i.entities||(i.entities={}),t?i.entities[r]=t:delete i.entities[r]}else i[e]=t}),i.entities&&0===Object.keys(i.entities).length&&delete i.entities,this._config=i,_t(this,"config-changed",{config:this._config})}_warningFormValueChanged(e){if(e.stopPropagation(),!this._config||!this.hass)return;const t=e.detail.value,i=JSON.parse(JSON.stringify(this._config));i.warnings||(i.warnings={}),Object.entries(t).forEach(([e,t])=>{const r=e.replace("warnings_","").split("_");let s,a;"rain"===r[0]&&"rate"===r[1]?(s="rain_rate",a=r.slice(2).join("_")):"wind"===r[0]&&"speed"===r[1]?(s="wind_speed",a=r.slice(2).join("_")):(s=r[0],a=r.slice(1).join("_")),i.warnings[s]||(i.warnings[s]={}),i.warnings[s][a]=t}),this._config=i,_t(this,"config-changed",{config:this._config})}resolveAutoEntities(e){const t={},i=this.hass.entities||{};Object.values(this.hass.states).forEach(r=>{const s=r.entity_id,a=Object.values(i).find(e=>e.entity_id===s);if(a?.device_id===e){const e=s.split(".")[1].toLowerCase();t[e]=s}});const r={};for(const[e,i]of Object.entries(ve)){r[e]=void 0;for(const s of i){let i=!1;for(const[a,n]of Object.entries(t))if(a.includes(s)){r[e]=n,i=!0;break}if(i)break}}return r}renderAutoAssignments(){if(!this._config.device_id)return I``;const e=this.resolveAutoEntities(this._config.device_id),t=this._config.entities||{};return I`
    ...
    `}_clearOverride(e){const t=JSON.parse(JSON.stringify(this._config));t.entities&&(delete t.entities[e],0===Object.keys(t.entities).length&&delete t.entities),this._config=t,_t(this,"config-changed",{config:this._config})}static get styles(){return n`
      .card-config {
        padding: 0;
      }
    ...
    `}};e([me({attribute:!1})],Tt.prototype,"hass",void 0),e([ge()],Tt.prototype,"_config",void 0),e([ge()],Tt.prototype,"_activeTab",void 0),Tt=e([le("weatherstation-card-editor")],Tt);let Pt=class extends ce{constructor(){super(...arguments),this.data=[],this.metric="temperature",this.width=80,this.height=Me,this.color="var(--primary-color, #03a9f4)",this.showGradient=!0,this.showDot=!0,this.showMinMax=!1,this.enableAnimation=!0,this._gradientId=`sp-${this.metric}-${Math.random().toString(36).substr(2,6)}`,this._hasAnimated=!1}render(){if(this.data.length<2)return I`<div class="no-data">—</div>`;const e=this.showDot?Ce+2:2,{path:t,min:i,max:r,points:s}=function(e,t,i,r=4){if(e.length<2)return{path:"",min:0,max:0,points:[]};const s="number"==typeof r?{top:r,right:r,bottom:r,left:r}:r,a=e.map(e=>e.value),n=Math.min(...a),o=Math.max(...a),d=o-n||1,c=t-s.left-s.right,h=i-s.top-s.bottom,l=e.map((t,i)=>({x:s.left+i/(e.length-1)*c,y:s.top+h-(t.value-n)/d*h,value:t.value})),p=l.map((e,t)=>`${0===t?"M":"L"} ${e.x.toFixed(1)} ${e.y.toFixed(1)}`).join(" ");return{path:p,min:n,max:o,points:l}}(this.data,this.width,this.height,{top:3,right:e,bottom:0,left:0}),a=s[s.length-1],n=this._gradientId,o=this.enableAnimation&&!this._hasAnimated;o&&(this._hasAnimated=!0);const d=s.length>0?`${t} L ${s[s.length-1].x} ${this.height} L ${s[0].x} ${this.height} Z`:"";return I`
      <div class="sparkline-container">
        ...
        ${this.showMinMax?I`
              <div class="min-max">
                <span class="min">${ut(i,this.metric)}</span>
                <span class="max">${ut(r,this.metric)}</span>
              </div>
            `:""}
      </div>
    `}static get styles(){return n`
    ...
    `}};e([me({type:Array})],Pt.prototype,"data",void 0),e([me({type:String})],Pt.prototype,"metric",void 0),e([me({type:Number})],Pt.prototype,"width",void 0),e([me({type:Number})],Pt.prototype,"height",void 0),e([me({type:String})],Pt.prototype,"color",void 0),e([me({type:Boolean})],Pt.prototype,"showGradient",void 0),e([me({type:Boolean})],Pt.prototype,"showDot",void 0),e([me({type:Boolean})],Pt.prototype,"showMinMax",void 0),e([me({type:Boolean})],Pt.prototype,"enableAnimation",void 0),Pt=e([le("weather-sparkline")],Pt);let Lt=class extends ce{constructor(){super(...arguments),this.metric="temperature",this.showValue=!0,this.compact=!1,this.pulse=!1}render(){if(!this.trend||"stable"===this.trend.direction)return I`
      ...
      >
        ...
        <div class="metric-body">
          <div class="metric-value-row">
            <span class="metric-value">${ut(t,e)}</span>
    ...
    `}renderMinMax(e,t){if(!t||0===t.length)return I``;const i=t.map(e=>e.value),r=Math.min(...i),s=Math.max(...i);return I`
      <div class="min-max-row">
        <span class="min-value">↓ ${ut(r,e)}</span>
        <span class="max-value">↑ ${ut(s,e)}</span>
      </div>
    `}renderCompactMetric(e,t){const i=t[e];if(void 0===i)return I``;const r=this.trends.get(e);return I`
      <div class="compact-metric">
        ...
        <div class="compact-info">
          <span class="compact-value">${ut(i,e)}</span>
    ...
    `}};e([me({attribute:!1})],Ot.prototype,"hass",void 0),e([ge()],Ot.prototype,"config",void 0),e([ge()],Ot.prototype,"currentDataView",void 0),e([ge()],Ot.prototype,"currentHistoryPeriod",void 0),e([ge()],Ot.prototype,"expandedMetric",void 0),e([ge()],Ot.prototype,"historyData",void 0),e([ge()],Ot.prototype,"trends",void 0),e([ge()],Ot.prototype,"lastHistoryFetch",void 0),Ot=e([le("weatherstation-card")],Ot);export{Ot as WeatherStationCard};
